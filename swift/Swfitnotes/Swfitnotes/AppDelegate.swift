...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let detailViewController = rightViewController.topViewController as! DetailViewController
        
//        let firstNote = masterViewController.frc.fetchedObjects?.first
//        detailViewController.detailItem = firstNote
        ...
        let controller = masterNavigationController.topViewController as! SwiftNoteCollectionViewController
 ...
 */
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Swfitnotes")
